\section{Knowledge Base \& Vector Retrieval Management}
...
\subsection{Knowledge Processing \& Retrieval Pipeline}

\subsubsection{Document Ingestion Flow}
...
\subsubsection{RAG Retrieval Sequence}
\begin{verbatim}
