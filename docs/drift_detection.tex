\section{Documentation Drift Detection}
...
\subsubsection{GitHub Event Ingestion (FR01)}
...
\subsubsection{AST Source Code Parsing (FR02)}
...
\subsubsection{Code-Doc Comparison \& Scoring (FR03, FR04)}
...
\subsubsection{Report Generation \& Alerting (FR05, FR06)}
